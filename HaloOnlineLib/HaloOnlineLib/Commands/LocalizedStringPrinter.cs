...
namespace HaloOnlineLib.Commands
{
	static class LocalizedStringPrinter
	{
		...
		public static List<DisplayString> PrepareForDisplay(MultilingualUnicodeStringList unic, StringIdCache stringIds, IEnumerable<HaloOnlineLib.TagStructures.MultilingualUnicodeStringList.LocalizedString> strings, GameLanguage language, string filter)
		{
