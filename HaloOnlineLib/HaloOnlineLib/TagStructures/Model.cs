...
{
	[TagStructure(Class = "hlmt", Size = 0x1B8)]
	public class Model
	{
		[TagElement]
		...
		[TagElement]
		public List<TagBlock18> Unknown154 { get; set; }
		[TagElement]
		public List<TagBlock19> Unknown160 { get; set; }
		[TagElement]
		public List<TagBlock20> Unknown16C { get; set; }
		[TagElement]
