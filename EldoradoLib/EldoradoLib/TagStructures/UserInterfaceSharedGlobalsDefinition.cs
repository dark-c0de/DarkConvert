...
namespace EldoradoLib.TagStructures
{
	...
	public class UserInterfaceSharedGlobalsDefinition
	{
		...
		[TagElement]
		public List<TagBlock0> Unknown74 { get; set; }
		[TagElement]
		public List<TagBlock1> Unknown80 { get; set; }
		[TagElement]
		public HaloTag Unknown8C { get; set; }
		[TagElement]
		public List<TagBlock6> Unknown9C { get; set; }
		[TagElement]
		public List<TagBlock7> UnknownA8 { get; set; }
		[TagElement]
		public List<TagBlock8> UnknownB4 { get; set; }
		[TagElement]
		...
		[TagElement]
		public byte[] Unknown368 { get; set; }
		[TagElement]
		...
		public class TagBlock1
		{
			...
			[TagElement]
			public List<TagBlock5> Unknown24 { get; set; }
